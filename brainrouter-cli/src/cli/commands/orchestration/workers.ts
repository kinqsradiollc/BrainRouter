/**
 * Orchestration handlers — worker threads + agent packs.
 * Extracted from cli/commands/orchestration.ts (god-file breakdown).
 * Commands: /workers, /pack.
 */

import chalk from 'chalk';
import { listPacks, packAgentIds, readPackState, isPackEnabled, enablePack, disablePack } from '@kinqs/brainrouter-core/pack';
...
export async function handleWorkersCommand(ctx: CommandContext): Promise<boolean> {
