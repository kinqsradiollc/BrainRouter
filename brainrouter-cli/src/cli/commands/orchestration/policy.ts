/**
 * Orchestration handlers — delegation + auto-chain preferences.
 * Extracted from cli/commands/orchestration.ts (god-file breakdown).
 * Commands: /delegation-policy, /auto-chain, /auto-review.
 */
...
export async function handlePolicyCommand(ctx: CommandContext): Promise<boolean> {
