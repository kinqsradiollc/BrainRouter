/**
 * Orchestration handlers — roles + child-agent listing/inspection.
 * Extracted from cli/commands/orchestration.ts (god-file breakdown).
 * Commands: /roles, /agents, /agent.
 */
...
export async function handleAgentsCommand(ctx: CommandContext): Promise<boolean> {
