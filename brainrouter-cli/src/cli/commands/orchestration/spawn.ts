/**
 * Orchestration handlers — spawning + child lifecycle.
 * Extracted from cli/commands/orchestration.ts (god-file breakdown).
 * Commands: /bg, /build, /spawn, /wait, /kill.
 */
...
export async function handleSpawnCommand(ctx: CommandContext): Promise<boolean> {
