/**
 * Free helper functions extracted from workflow.ts as part of the god-file
 * breakdown. These are the cross-cutting bits the `tryHandleWorkflowCommand`
 * switch reaches for: `--force` parsing, the workflow-switch banner, and the
 * best-effort plan-decision memory capture.
 */
