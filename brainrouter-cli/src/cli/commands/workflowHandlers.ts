/**
 * The `/…` slash-command dispatch for workflow / plan / goal / review / loop
 * commands. Extracted from workflow.ts as part of the god-file breakdown; the
 * original file is now a thin re-export barrel over these sibling modules.
 *
...
import { shouldSkipGrillMe } from './workflowGrillGuard.js';
import { normalizeSkillsList } from './workflowSkills.js';
import { capturePlanDecision, parseForceFlag, printWorkflowSwitchConfirmation } from './workflowHelpers.js';
