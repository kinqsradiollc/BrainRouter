...
import { evaluateCommandPolicy, splitCommandSegments, segmentHead } from '../runtime/exec/commandPolicy.js';
import { resolveRunCommandApproval } from '../runtime/exec/dangerousCommand.js';
