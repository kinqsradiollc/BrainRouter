...
- **Capability-aware runtime.** Root and delegated agents resolve domain
  ...
  tags per task. Required primary profile stages now activate their declared
  skills in order and narrow the live tool surface until each skill completes.
  Existing access mode, role, allowlist, and deny rules remain authoritative.
