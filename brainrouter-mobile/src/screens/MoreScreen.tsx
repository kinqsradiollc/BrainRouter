...
type ToolKey = 'Memory' | 'Connectors' | 'Requirements' | 'Annotations' | 'Artifacts' | 'Schedules' | 'CI' | 'Worktrees' | 'Search' | 'Files' | 'Track' | 'Terminal' | 'Editor';
...
const TOOLS: Array<{ key: ToolKey; label: string; icon: IconName; desc: string }> = [
  ...
  { key: 'Connectors', label: 'Connectors', icon: 'plug', desc: 'Sources & sync status (GitHub, Slack, Notion…)' },
