...
export default function HomePage() {
  ...
  // Interactive Consolidation & Learning demo (state + step handlers)
  const {
    learningStep,
    consolidationLogs,
    visNodes,
  ...
  // Interactive Mock SNN Simulator demo (potentials + spike/decay handlers)
  const {
    mockSkills,
    consoleLogs,
    prewarmedSkills,
                  ...
                  >
                    ...
                    >
                      <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: "6px" }}>
                        <Glyph name="bolt" size={13} /> Spike potential (+1.2)
                      </span>
                    </button>
                  </div>
                );
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "200px", width: "100%", maxWidth: "700px", zIndex: 2 }}>
            <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="card" style={{ background: "var(--surface-pewter-accent)", padding: "20px", border: "1px solid var(--border-med)", boxShadow: "0 8px 30px var(--overlay-bg)", textAlign: "center" }}>
              <div style={{ marginBottom: "8px", color: "var(--accent)" }}><Glyph name="agent" size={22} /></div>
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="card" style={{ background: "var(--surface-pewter-accent)", padding: "20px", border: "1px solid var(--border-med)", boxShadow: "0 8px 30px var(--overlay-bg)", textAlign: "center" }}>
              <div style={{ marginBottom: "8px", color: "var(--accent)" }}><Glyph name="monitor" size={22} /></div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "200px", width: "100%", maxWidth: "700px", zIndex: 2 }}>
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="card" style={{ background: "var(--surface-pewter-accent)", padding: "20px", border: "1px solid var(--border-med)", boxShadow: "0 8px 30px var(--overlay-bg)", textAlign: "center" }}>
              <div style={{ marginBottom: "8px", color: "var(--accent)" }}><Glyph name="phone" size={22} /></div>
