...
fixes. Six remaining workstreams: see
...
|---|---|---|
| **[0.3.6](brainrouter-roadmap/0.3.6.md)** | CLI UX tranche + multi-workflow + relevance judge | _In-flight_ — 8 items, 3 shipped (Items 1 + 2 + 2b via PR #26 + #27 + #30) |
