...
|---|---|---|---|
| Next | **0.4.9** | Planned — **dashboard redesign** to BrainRouter's own design language ("The Memory Instrument" — retire the slash/Inter/serif/golden copycat; one Signal accent `#34C28E` + Recall-Heat data ramp; Geist + Geist Mono; color-stepped elevation) + **API hardening** (zod validation on all 16 routes, fail-closed JWT secret, security headers + strict CORS, rate-limiting, vuln-free, behavior-preserving). **Gated on a styling review.** | [`docs/design/themes/brainrouter.md`](docs/design/themes/brainrouter.md) |
...
| **[0.4.9](docs/design/themes/brainrouter.md)** | **Dashboard redesign** to BrainRouter's own design language ("The Memory Instrument" — retire the slash/Inter/serif/golden copycat; Signal accent + Recall-Heat ramp; Geist + mono; color-stepped elevation) + **API hardening** (zod validation on all 16 routes, fail-closed JWT secret, security headers + strict CORS, rate-limiting, vuln-free, behavior-preserving) | Planned — gated on styling review |
