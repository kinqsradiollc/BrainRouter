...
|---|---|---|
| **0.4.22** | In development — a simple, native Desktop workbench with a task-led start surface across Chat, Code, Track, panels, and Settings; the browser preview now mirrors the shell queries it needs for clean visual verification | [`brainrouter-changelog/0.4.22.md`](brainrouter-changelog/0.4.22.md) |
