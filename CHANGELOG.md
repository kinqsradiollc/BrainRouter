...
|---|---|---|
| **0.4.18** | Qualified candidate — unpublished — native Desktop appearance, unified workbench surfaces, persistent panel state, faster Files/Editor navigation, and phase-aware plan execution | [`brainrouter-changelog/0.4.18.md`](brainrouter-changelog/0.4.18.md) |
