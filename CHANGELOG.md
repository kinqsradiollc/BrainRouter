...
|---|---|---|
| **0.4.17** | Unreleased — conversational workspace setup, profile-aware agent runtime, stable revisioned work identity, scoped specialist packs, and Project knowledge from bounded ingest through citation-backed Dashboard/Desktop workflows | [`brainrouter-changelog/0.4.17.md`](brainrouter-changelog/0.4.17.md) |
