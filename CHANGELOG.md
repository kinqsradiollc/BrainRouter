...
|---|---|---|
| **0.4.17** | Unreleased — typed workspace setup, recoverable global/project commits, one engineer with task-time capabilities, and commit-first brain/account selection | [`brainrouter-changelog/0.4.17.md`](brainrouter-changelog/0.4.17.md) |
