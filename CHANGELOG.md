...
|---|---|---|
| **0.4.17** | Unreleased — conversational workspace setup, one engineer with task-time frontend capabilities, scoped specialist packs, and Project knowledge from bounded ingest through citation-backed Dashboard/Desktop workflows | [`brainrouter-changelog/0.4.17.md`](brainrouter-changelog/0.4.17.md) |
