...
8 required-core capability extensions activating 93 built-in tools.

| Capability | Tools | Members |
|------------|-------|---------|
| `filesystem` | 17 | `apply_patch`, `atlas_context`, `design_detect`, `diagram_draft`, `diagram_render`, `diagram_validate`, `edit_file`, `glob_files`, `grep_search`, `list_dir`, `notebook_edit`, `read_file`, `worktree_create`, `worktree_done`, `worktree_enter`, `worktree_list`, `write_file` |
