...
8 required-core capability extensions activating 96 built-in tools.
...
| `planning-state` | 22 | `artifact_write`, `ask_user_choice`, `goal_blocked`, `goal_complete`, `mark_chapter`, `notify_when_idle`, `planner_add`, `planner_complete`, `planner_find`, `planner_schedule`, `planner_today`, `reconcile_steer`, `remind`, `suggest_task`, `switch_model`, `track_query`, `track_update`, `update_plan`, `workspace_create`, `workspace_link`, `workspace_resolve`, `workspace_update` |
