...
8 required-core capability extensions activating 87 built-in tools.

| Capability | Tools | Members |
|------------|-------|---------|
| `filesystem` | 12 | `apply_patch`, `edit_file`, `glob_files`, `grep_search`, `list_dir`, `notebook_edit`, `read_file`, `worktree_create`, `worktree_done`, `worktree_enter`, `worktree_list`, `write_file` |
