...
| draft [--layers a,b] [--prefix p] \| import <file.mmd> [--kind k] \| validate <file> \| render <file> [--slug s] [--theme t] [--no-verify] \| diff <slug> [--base rev] \| list \| show <slug> \| open <slug> \| /diagram <kind> <what…> | Typed, validated system maps (architecture, workflow, sequence, dataflow, lifecycle) rendered to self-contained HTML with a receipt under .brainrouter/diagrams/ |
