...
| A25-11b2 | `[ ]` | Normalize deterministic analyzer discoveries and their exact-revision evidence into the same finding identity | Cross-file mechanism fixtures retain analyzer provenance, exact anchors, evidence references, and stable fingerprints without duplicating model candidates |
