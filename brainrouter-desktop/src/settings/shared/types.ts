...
export const NAV: SettingsNavItem[] = [
  ...
  { section: 'runtime', icon: 'terminal', title: 'Runtime', group: 'Automation', description: 'Execution backends, isolated runs, and preview port defaults', keywords: 'execution engine loop graph turn comprehension understand review questions container host worktree archive jit secrets serve remote runtime preview port reservations budget critic hosted cli agents' },
