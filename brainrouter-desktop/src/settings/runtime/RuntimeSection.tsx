...
import { Row, Toggle, Select, KnobNumber, KnobText } from '../shared/controls.js';
...
export function RuntimeSection({ knobs, setPath, runtimes = [], archives = [], previews = [], onAction, refreshSnapshot }: {
  ...
  return (
    <>
      ...
      {backend === 'container' ? (
        <>
          <div className="set-h2">Container backend</div>
      ...
      <div className="set-h2">Workspace archives</div>
      ...
      <div className="set-h2">JIT secrets</div>
      ...
      <div className="set-h2">Serve &amp; remote</div>
      ...
      <div className="set-h2">Critic (agent self-review)</div>
...
function PreviewPortsEditor({ ports, onChange }: { ports: Record<string, number>; onChange: (next: Record<string, number>) => void }): React.ReactElement {
  ...
  return (
    <>
      <div className="set-h2">App-preview ports</div>
...
function HostedAgentsEditor({ hosted, onChange }: { hosted: HostedAgent[]; onChange: (next: HostedAgent[]) => void }): React.ReactElement {
  ...
  return (
    <>
      <div className="set-h2">Hosted CLI agents</div>
