      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
          ...
          <motion.div
            ...
            style={{
              ...
              background: "linear-gradient(135deg, rgba(28, 29, 34, 0.65) 0%, rgba(12, 13, 17, 0.95) 100%)",
              border: "1px solid rgba(226, 227, 233, 0.08)",
              borderRadius: "16px",
              padding: "24px",
              boxShadow: isHovered 
                ? "0 35px 60px rgba(0,0,0,0.75), 0 0 50px rgba(174, 147, 87, 0.08)"
                : "0 25px 50px rgba(0,0,0,0.6), 0 0 40px rgba(174, 147, 87, 0.05)",
              position: "relative",
              display: "flex",
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", zIndex: 1 }}>
              ...
              <div style={{
                ...
                <div style={{ position: "absolute", top: "25%", left: "20%", right: "20%", height: "50%", borderLeft: "1px solid rgba(0,0,0,0.15)", borderRight: "1px solid rgba(0,0,0,0.15)" }} />
              </div>
        ...
        >
          ...
          <div style={{
            ...
            padding: "4px",
            borderRadius: "var(--radius-pill)",
            border: "1px solid rgba(226, 227, 233, 0.06)",
            position: "relative",
            width: "100%"
          }}>
            <button 
