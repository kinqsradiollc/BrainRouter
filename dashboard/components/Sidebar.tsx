  ...
  return (
    <motion.aside 
      ...
      style={{
        ...
        borderRight: isCollapsed ? "0px solid transparent" : "1px solid rgba(226, 227, 233, 0.06)",
        zIndex: 100,
        overflow: "hidden"
      }}
    >
      ...
      {!isCollapsed && (
        <button
          ...
          onMouseOut={(e) => {
            ...
            e.currentTarget.style.borderColor = "rgba(226, 227, 233, 0.1)";
          }}
        >
          <svg
            style={{
                ...
                {isActive && (
                  <motion.div
                    ...
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      background: "linear-gradient(90deg, rgba(174, 147, 87, 0.2) 0%, rgba(255, 240, 204, 0.08) 40%, rgba(174, 147, 87, 0.15) 70%, rgba(189, 157, 79, 0) 100%)",
      ...
      <div style={{ marginTop: "auto", display: "flex", flexDirection: "column", gap: "10px", width: "100%" }}>
        ...
        {!isCollapsed ? (
          <div style={{ padding: "10px", borderTop: "1px solid rgba(226, 227, 233, 0.04)" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", padding: "10px 0", borderTop: "1px solid rgba(226, 227, 233, 0.04)" }}>
            <span 
