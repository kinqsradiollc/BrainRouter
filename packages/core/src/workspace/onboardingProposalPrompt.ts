...
export function buildWorkspaceOnboardingPrompt(
  ...
  return {
    system: [
      ...
      'Use one engineer persona for every engineering project. Never emit frontend-builder or backend-engineer.',
      ...
      'Backend is an enabled capability for API, service, authorization, persistence, background-work, deployment, observability, or backend-test work; it is not a persona and grants no tools by itself.',
