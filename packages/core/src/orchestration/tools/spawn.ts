...
import { buildRolePrompt, resolveRole, type AccessMode } from '../registry/roles.js';
import { countRunningChildren, spawnSlotDecision } from '../session/spawnSlots.js';
import { findById, listAll, type Tier } from '../registry/agentRegistry.js';
...
import { getOutputContract } from '../registry/outputContracts.js';
