...
import { getSession, updateSession, type ChildSessionRecord } from '../session/orchestrator.js';
import { buildRolePrompt, resolveRole } from '../registry/roles.js';
import { findById, type Tier } from '../registry/agentRegistry.js';
