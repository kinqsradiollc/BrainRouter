...
import { resolvePacks, discoverPacks, listPacks, packAgentIds, type PackInfo } from '../pack/packs.js';
import { isPackEnabled, readPackState, enablePack, disablePack } from '../pack/packStore.js';
