...
export const SLASH_COMMANDS = [
  ...
  '/spec', '/feature-dev', '/grill-me', '/review', '/reviews', '/review-auto', '/simplify', '/implement-plan', '/skill', '/workflow', '/workflows', '/approve', '/requirement', '/track', '/annotation', '/artifact', '/atlas', '/diagram', '/design', '/attach',
  ...
  '/goal', '/copy', '/fork', '/rename', '/permissions', '/recent-denials', '/recent-decisions', '/decision-calibration', '/hooks', '/hookify', '/loop', '/schedule', '/playbook',
...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { cmd: 'draft [--layers a,b] [--prefix p] | import <file.mmd> [--kind k] | validate <file> | render <file> [--slug s] [--theme t] [--no-verify] | diff <slug> [--base rev] | list | show <slug> | open <slug> | /diagram <kind> <what…>', desc: 'Typed, validated system maps (architecture, workflow, sequence, dataflow, lifecycle) rendered to self-contained HTML with a receipt under .brainrouter/diagrams/' },
      { cmd: '/design <verb> [targets…] [--mode persuade|operate|read|experience] [--world id] | detect [paths…] [--rules a,b] [--json] | rules | hooks [on|off|immediate|full] | verbs', desc: 'Design as verbs (critique, audit, polish, harden, typeset, layout, colorize, document, product, …) routed to the one design skill, plus the deterministic detector: slop tells, quality defects, design.md token drift; suppressions in .brainrouter/design-detector.json' },
      ...
      { cmd: '/playbook run <name> --param k=v  ·  /playbook init|list|schedule', desc: 'Run a parameterized, schedulable automation unit' },
  ...
  },
  {
    ...
    entries: [
      ...
      { cmd: '/recent-decisions [n]', desc: 'List the last N decision-tier answers (what was asked, the probability, what the gate did)' },
      { cmd: '/decision-calibration [provider]', desc: 'Does the decision tier\'s stated probability track what actually happened' },
