...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { cmd: '/diagram <kind> <what…> | draft [--layers a,b] [--prefix p] | validate <file> | render <file> [--slug s] [--theme t] [--no-verify] | list | show <slug> | open <slug>', desc: 'Typed, validated system maps (architecture, workflow, sequence, dataflow, lifecycle) rendered to self-contained HTML with a receipt under .brainrouter/diagrams/' },
