...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { cmd: '/design detect [paths…] [--rules a,b] [--json] | rules | hooks [on|off|immediate|full]', desc: 'Deterministic design checks over UI files (no model): slop tells, quality defects, design.md token drift; suppressions in .brainrouter/design-detector.json' },
