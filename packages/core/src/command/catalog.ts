...
export const SLASH_COMMANDS = [
  ...
  '/goal', '/copy', '/fork', '/rename', '/permissions', '/recent-denials', '/hooks', '/hookify', '/loop', '/schedule', '/playbook',
...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { cmd: '/diagram <kind> <what…> | draft [--layers a,b] [--prefix p] | validate <file> | render <file> [--slug s] [--theme t] [--no-verify] | diff <slug> [--base rev] | list | show <slug> | open <slug>', desc: 'Typed, validated system maps (architecture, workflow, sequence, dataflow, lifecycle) rendered to self-contained HTML with a receipt under .brainrouter/diagrams/' },
